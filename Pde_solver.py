...
class Solver(pints.ForwardModel):
    ...
    def __init__(self, n_grid=256, n_time_points=8000, model='gray-scott',
        ...
        self.u_mat[spat_slice, spat_slice] = 0.5
        ...
        self.init_u_mat = self.u_mat.copy()
    ...
    def solve(self, parameters):
        ...
        for i_tau in tqdm(range(self.n_times)):
            ...
            self.u_mat, self.v_mat = self.update_uv(old_u_mat=old_u, old_v_mat=old_v)
    ...
    def plot2d(self, save_figures=False):
        ...
        """
        filename_uv = f'u_matrix_F={self.F}_k={self.k}.png'
    ...
    def n_parameters(self):
        """Return number of parameters for inference (F and K)"""
        return 2
